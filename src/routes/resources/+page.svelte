...
<div class="flex flex-col mt-8 mb-7">
  {#if currentPage !== totalOfPages}
    <div class="flex justify-center">
      <div
        class="text-[20px] cursor-pointer w-[200px] p-2 mt-[20px] mb-[10px] bg-[#2F5AAE] text-white flex justify-center rounded-full hover: bg-blue-500 shadow-lg shadow-blue-500/50  "
        on:click={handelLoadMore}
      >
        Load More...
      </div>
    </div>
  {:else}
    <div class="flex justify-center">
      <div
        class="text-[20px]  w-[200px] p-2 mt-[20px] mb-[10px] bg-[#cccccc] text-gray-700 flex justify-center rounded-full  "
      >
        No more Results
      </div>
    </div>
  {/if}
  <div class="flex justify-center mt-[10px] mb-[10px] text-[#888888]  ">
...
<div class="flex justify-end">
  <div
    class="fixed bottom-20 flex justify-center items-center bg-sky-500/[0.7] hover:bg-[#3B82F6] w-[50px] h-[50px] text-white rounded-r-[5px] rounded-l-[5px] cursor-pointer"
